...
{
    $http.get('/PRENOTE').success(function(response) {
...
$scope.edit = function(id) {
    console.log(id);
    $http.get('/PRENOTE/' + id).success(function(response) {
      $scope.rows = response;
...
//f(3)  
  $scope.update = function() {
    ...
    $http.put('/PRENOTE/' + $scope.rows._id, $scope.rows).success(function(response) {
      refresh();
    })
  };
